...
const Landing = () => {
  ...
  return (
    <div className="bg-white border-gray-200 dark:bg-teal-950 dark:text-white m-0">
      
      {page ? (
        <div>
          <div className="flex flex-wrap m-0 justify-around align-middle">
          ...
          <div className="flex justify-center m-0 py-8">
